...
# Generated by running ./build_linux.sh --arch arm64 in vendor/webrtc-sys/libwebrtc
Source2:	libwebrtc-aarch64.tar.xz
# x86 version provided by upstream, should probably built it from source too to be on the safe side
Source3:	https://github.com/zed-industries/webrtc/releases/download/m114_release_patched/webrtc-linux-x64-release.zip	
...
cd vendor/webrtc-sys/libwebrtc
%ifarch %{aarch64}
tar xf %{S:2}
%else
tar xf %{S:3}
